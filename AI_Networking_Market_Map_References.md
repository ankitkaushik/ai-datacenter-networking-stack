...
## Source PDFs (user-supplied, used as starting hypothesis and cross-checked against the above)

[P1] *AI Networking: Why the Next Bottleneck Isn't GPUs* — investor memo v3 (user-supplied, May 2026).

[P2] *AI Datacenter Networking* — notes file (user-supplied) covering Spectrum-X, CPO, LPO, EML shortage, switch silicon.

[P3] *Atoms + Bits: The New Industrial Architecture of Physical AI v3* (user-supplied) — broader Physical AI taxonomy; cited for Broadcom + DoD VMware, Lumentum/Coherent EML duopoly, Tower SiPho share.

[P4] *Physical AI Notes (2)* (user-supplied) — Credo/DustPhotonics, Marvell/Inphi/Celestial AI competitive landscape, POET, MaxLinear positioning.
